<script>
import CurrentSeriesCardVue from './CurrentSeriesCard.vue';
export default{
    name: "AppMain",
    components:{
      CurrentSeriesCardVue
    },
    data(){
      return{
        currentSeries: [
...
<template>
  <main>
    <div class="container">
        ...
        <div class="cards">
            <CurrentSeriesCardVue v-for="(card, index) in currentSeries" :key="index" :thumb="card.thumb" :title="card.series"/>
        </div>
